            ...
            {malformed ? (
              <div className="space-y-4">
                <div className="mb-2">
                  <h1 className="mb-1.5 font-display text-[22px] font-semibold tracking-tight text-[var(--color-foreground)]">
                    {t("resetPassword.malformedLead")} {" "}
                    <span className="text-[var(--color-primary)]">{t("resetPassword.malformedAccent")}</span>
                  </h1>
              ...
              <>
                <div className="mb-6 sm:mb-8">
                  <h1 className="mb-1.5 font-display text-[22px] font-semibold tracking-tight text-[var(--color-foreground)]">
                    {t("resetPassword.titleLead")} {" "}
                    <span className="text-[var(--color-primary)]">{t("resetPassword.titleAccent")}</span>
                  </h1>
