...
export const topNavTop: NavSpec[] = [
  { to: "/", label: "Overview", labelKey: "overview", icon: LayoutDashboard },
  ...
  { to: "/chat", label: "Chat", labelKey: "chat", icon: MessageCircle, perm: "Permissions.Chat.Channels.View" },
  { to: "/files", label: "My Files", labelKey: "myFiles", icon: FolderOpen, perm: "Permissions.Files.Upload" },
];
...
export const sections: NavSection[] = [
  {
    ...
    items: [
      ...
      { to: "/activity", label: "Live activity", labelKey: "liveActivity", icon: Activity },
      { to: "/subscription", label: "Subscription", labelKey: "subscription", icon: CreditCard, perm: "Permissions.Billing.View" },
      { to: "/wallet", label: "WhatsApp wallet", labelKey: "whatsappWallet", icon: Wallet, perm: "Permissions.Billing.View" },
      { to: "/invoices", label: "Invoices", labelKey: "invoices", icon: Receipt, perm: "Permissions.Billing.View" },
    ],
  },
  {
    id: "catalog",
    ...
    icon: Package,
    items: [
      { to: "/catalog/products", label: "Products", labelKey: "products", icon: Package, perm: "Permissions.Catalog.Products.View" },
      { to: "/catalog/brands", label: "Brands", labelKey: "brands", icon: Tags, perm: "Permissions.Catalog.Brands.View" },
      { to: "/catalog/categories", label: "Categories", labelKey: "categories", icon: FolderTree, perm: "Permissions.Catalog.Categories.View" },
    ],
  },
  {
    id: "helpdesk",
    ...
    icon: Ticket,
    items: [
      { to: "/tickets", label: "Tickets", labelKey: "tickets", icon: Ticket, perm: "Permissions.Tickets.View" },
    ],
  },
  {
    id: "identity",
    ...
    items: [
      ...
      { to: "/identity/users", label: "Users", labelKey: "users", icon: Users, perm: "Permissions.Users.Update" },
      { to: "/identity/roles", label: "Roles", labelKey: "roles", icon: ShieldCheck, perm: "Permissions.Roles.Update" },
      { to: "/identity/groups", label: "Groups", labelKey: "groups", icon: UsersRound, perm: "Permissions.Groups.Update" },
    ],
  },
  {
    id: "system",
    ...
    items: [
      ...
      { to: "/system/health", label: "Health", labelKey: "health", icon: HeartPulse },
      { to: "/system/audits", label: "Audit trail", labelKey: "auditTrail", icon: ScrollText, perm: "Permissions.AuditTrails.View" },
      { to: "/system/sessions", label: "Sessions", labelKey: "sessions", icon: Wifi, perm: "Permissions.Sessions.ViewAll" },
      ...
      { to: "/system/trash", label: "Trash", labelKey: "trash", icon: Trash2, anyPerm: ALL_TRASH_PERMISSIONS },
    ],
  },
];
